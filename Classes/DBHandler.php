<?php
  ...
  class DBHandler implements IModel{
     ...
     * @param array $fields fields been selected [field1,field2, ...fieldn]
     * @return mix $data the gotten data if successful or false if no record
     */
    public function iRetrieveData($line, $criteria=FALSE, $fields=FALSE){
      $bindData=array();
      if($fields){
        $fieldsList="";
      ...
      $sql="SELECT $fieldsList FROM ".$this->_table." $where";
			//var_dump($sql);exit;
